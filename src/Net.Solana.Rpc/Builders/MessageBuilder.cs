...
using Net.Solana.Rpc.Utilities;
using Net.Solana.Wallet;
using Net.Solana.Wallet.Utilities;

namespace Net.Solana.Rpc.Builders;
...
public class MessageBuilder
{
    ...
    /// </summary>
    public List<TransactionInstruction> Instructions { get; private protected set; }
    ...
    public MessageBuilder AddInstruction(TransactionInstruction instruction)
    {
