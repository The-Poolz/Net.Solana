...
public class SolanaRpcBatchComposer
{
    ...
    /// <summary>
    /// Clears the public list of requests
    /// </summary>
    public void Clear()
    {
        _reqs.Clear();
    ...
    public void AddRequest<T>(string method, IList<object> parameters, Action<T, Exception> callback)
    {
    ...
    public Task<T> AddRequest<T>(string method, IList<object> parameters)
    {
    ...
    public void Add(RpcBatchReqRespItem task) 
    {
        // add to batch
        _reqs.Add(task);
...
/// </summary>
public class RpcBatchReqRespItem
{
    /// <summary>
    ...
    /// <returns></returns>
    public static RpcBatchReqRespItem Create<T>(int id, string method, IList<object> parameters,
