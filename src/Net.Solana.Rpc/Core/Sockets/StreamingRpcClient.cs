...
/// </summary>
public abstract class StreamingRpcClient : IDisposable
{
    ...
    /// <summary>
    /// The public constructor that setups the client.
    /// </summary>
    ...
    protected StreamingRpcClient(string url, ILogger? logger = null, IWebSocket? socket = default, ClientWebSocket? clientWebSocket = default)
    {
