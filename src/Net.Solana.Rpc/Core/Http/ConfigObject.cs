...
{
    public static Dictionary<string, object> Create(KeyValue pair1)
    {
        if (pair1 != null)
        {
    ...
    public static Dictionary<string, object> Create(KeyValue pair1, KeyValue pair2)
    {
    ...
    public static Dictionary<string, object> Create(KeyValue pair1, KeyValue pair2, KeyValue pair3)
    {
    ...
    public static Dictionary<string, object> Create(KeyValue pair1, KeyValue pair2, KeyValue pair3, KeyValue pair4)
    {
    ...
    public static Dictionary<string, object> Create(KeyValue pair1, KeyValue pair2, KeyValue pair3, KeyValue pair4, KeyValue pair5)
    {
...
{
    public static List<object> Create(object val1)
    {
        if (val1 != null)
        {
    ...
    public static List<object> Create(object val1, object val2)
    {
    ...
    public static List<object> Create(object val1, object val2, object val3)
    {
