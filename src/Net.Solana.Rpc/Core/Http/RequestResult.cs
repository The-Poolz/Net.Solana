...
public class RequestResult<T> : IRequestResult
{
    ...
    /// </summary>
    public string RawRpcRequest { get; protected internal set; }

    /// <summary>
    /// Contains the JSON RPC response payload
    /// </summary>
    public string RawRpcResponse { get; protected internal set; }
    ...
    public RequestResult(HttpStatusCode code, string reason)
    {
        HttpStatusCode = code;
        Reason = reason;
