...
namespace Net.Solana.Rpc.Tests;
...
public class SolanaRpcClientTransactionsTest : SolanaRpcClientTestBase
{
    ...
    public void TestSimulateTransaction()
    {
        ...
        Assert.AreEqual((object)null, result.Result.Value.Error);
    ...
    public void TestSimulateTransactionWithTransactionErrorObject()
    {
        ...
        Assert.AreEqual((object)TransactionErrorType.InsufficientFundsForRent, result.Result.Value.Error.Type);
    ...
    public void TestSimulateTransactionInsufficientLamports()
    {
        ...
        Assert.IsNotNull(result.Result.Value.Error);
        Assert.AreEqual((object)TransactionErrorType.InstructionError, result.Result.Value.Error.Type);
        Assert.IsNotNull(result.Result.Value.Error.InstructionError);
        Assert.AreEqual((object)InstructionErrorType.Custom, result.Result.Value.Error.InstructionError.Type);
