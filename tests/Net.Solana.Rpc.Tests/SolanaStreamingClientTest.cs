...
public class SolanaStreamingClientTest
{
    ...
    public void SubscribeSignatureTest()
    {
        ...
        Assert.AreEqual((object)SubscriptionStatus.Unsubscribed, sub.State);
    }
    ...
    public void SubscribeBadAccountTest()
    {
        ...
        Assert.AreEqual((object)SubscriptionStatus.ErrorSubscribing, sub.State);
    }
    ...
    public void SubscribeAccountBigPayloadTest()
    {
        ...
        Assert.AreEqual((object)SubscriptionStatus.Subscribed, sub.State);
