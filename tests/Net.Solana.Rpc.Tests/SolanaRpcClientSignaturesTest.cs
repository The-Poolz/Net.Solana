...
public class SolanaRpcClientSignaturesTest : SolanaRpcClientTestBase
{
    ...
    public void TestGetSignaturesForAddress()
    {
        ...
        Assert.AreEqual((object)null, result.Result[0].Memo);
        Assert.AreEqual((object)null, result.Result[0].Error);
    ...
    public void TestGetSignaturesForAddressUntil()
    {
        ...
        Assert.AreEqual((object)null, result.Result[0].BlockTime);
    ...
    public void TestGetSignatureStatuses()
    {
        ...
        Assert.AreEqual((object)null, result.Result.Value[1]);
    ...
    public void TestGetSignatureStatusesWithHistory()
    {
        ...
        Assert.AreEqual((object)null, result.Result.Value[0].Confirmations);
