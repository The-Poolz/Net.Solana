...
namespace Net.Solana.Extensions.Tests;
...
public class TokenMintTest
{
    ...
    public void TestTokenInfoResolverParseAndFind()
    {
        ...
        Assert.AreEqual((object)WellKnownTokens.WrappedSOL.Symbol, wsol.Symbol);
        Assert.AreEqual((object)WellKnownTokens.WrappedSOL.TokenName, wsol.TokenName);
        Assert.AreEqual((object)WellKnownTokens.WrappedSOL.TokenMint, wsol.TokenMint);
        Assert.AreEqual((object)WellKnownTokens.WrappedSOL.DecimalPlaces, wsol.DecimalPlaces);
    ...
    public void TestTokenInfoResolverUnknowns()
    {
        ...
        Assert.AreEqual((object)unknown.TokenMint, known.TokenMint);
    ...
    public void TestDynamicTokenDefCreateQuantity()
    {
        ...
        Assert.AreEqual((object)pubkey.Key, qty.TokenMint);
        Assert.AreEqual(4741784U, qty.QuantityRaw);
