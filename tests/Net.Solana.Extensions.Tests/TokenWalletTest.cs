...
using Net.Solana.Extensions.Models.TokenWallet;
using Net.Solana.Programs;
using Net.Solana.Rpc;
using Net.Solana.Rpc.Builders;
...
public class TokenWalletTest
{
    ...
    public void TestLoadKnownMint()
    {
        ...
        Assert.AreEqual((object)testToken.TokenMint, wallet.TokenAccounts().WithSymbol("TEST").First().TokenMint);
        Assert.AreEqual((object)testToken.Symbol, wallet.TokenAccounts().WithMint("98mCaWvZYTmTHmimisaAQW4WGLphN1cWhcC7KtnZF819").First().Symbol);
