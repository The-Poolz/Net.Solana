...
using Net.Solana.Programs.Models;
using Net.Solana.Programs.Models.TokenProgram;
...
public class TokenProgramTest
{
    ...
    public void TokenAccountDeserialization()
    {
        ...
        Assert.AreEqual((object)null, tokenAcc.CloseAuthority);
        Assert.AreEqual((object)null, tokenAcc.Delegate);
        Assert.AreEqual((object)null, tokenAcc.IsNative);
        ...
        Assert.AreEqual((object)Models.TokenProgram.TokenAccount.AccountState.Initialized, tokenAcc.State);
    }
